    ...
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
        ...
        <DialogContent dividers sx={{ bgcolor: '#FAFAFA', p: 3 }}>
            <Grid container spacing={2}>
                ...
                <Grid size={{ xs: 12, md: 6 }}><TextField label="Breed" fullWidth size="small" sx={{bgcolor: 'white'}} value={newPetData.breed} onChange={(e)=>setNewPetData({...newPetData, breed:e.target.value})} /></Grid>
                <Grid size={{ xs: 12, md: 6 }}><TextField label="Color" fullWidth size="small" sx={{bgcolor: 'white'}} value={newPetData.color} onChange={(e)=>setNewPetData({...newPetData, color:e.target.value})} /></Grid>
                <Grid size={{ xs: 12, md: 6 }}><TextField select label="Sex" fullWidth size="small" sx={{bgcolor: 'white'}} value={newPetData.gender} onChange={(e)=>setNewPetData({...newPetData, gender:e.target.value})}><MenuItem value="Male">Male</MenuItem><MenuItem value="Female">Female</MenuItem></TextField></Grid>
                <Grid size={{ xs: 12, md: 6 }}><TextField type="date" label="Birthday" fullWidth size="small" sx={{bgcolor: 'white'}} InputLabelProps={{shrink: true}} value={newPetData.dob} onChange={(e)=>setNewPetData({...newPetData, dob:e.target.value})} /></Grid>
